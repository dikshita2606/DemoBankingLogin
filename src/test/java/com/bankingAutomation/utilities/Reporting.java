...
public class Reporting extends TestListenerAdapter
{
	  ...
	  String repName="Test-ReportDJ-"+timeStamp+".html";
	  ...
	  extent.setSystemInfo("user","Dikshita");
	  
	  htmlReporter.config().setDocumentTitle("Guru 99 Banking Project Report"); //	  Tile of report
	  htmlReporter.config().setReportName("Banking Project Demo Report"); // name	  of the report
